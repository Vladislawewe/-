...
PROMPT .STRINGZ "Введите 10 чисел: "
NUMBERS .BLKW 10           ; Выделение памяти для 10 чисел
CONSTATEXP .BLKW 10        ; Выделение памяти для 10 символов
COUNT .FILL #10            ; Количество чисел для ввода
